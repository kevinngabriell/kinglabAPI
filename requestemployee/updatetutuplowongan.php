...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $update_log_query = "UPDATE new_employee_request SET last_status = 'NEW-STATUS-004', updated_by = '$employee_id', updated_dt = '$currentDateTimeString' WHERE id_new_employee_request = '$request_id';";
    $insert_history_query = "INSERT IGNORE INTO new_employee_request_log 
        (id, new_request_id, action, action_by, action_dt) VALUES 
        (NULL, '$request_id', 'Permintaan karyawan baru telah ditutup', '$employee_id', '$currentDateTimeString');";
