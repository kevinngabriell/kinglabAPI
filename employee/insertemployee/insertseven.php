...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query_2 = "UPDATE employee_emergency_contact 
SET 
    emergency_name = '$emergency_name', 
    emergency_hubungan = '$emergency_hubungan', 
    emergency_phone = '$emergency_phone', 
    emergency_address = '$emergency_address'
WHERE id = '$id' AND `index` = 1;";
    $query_3 = "INSERT INTO employee_emergency_contact (id, emergency_name, emergency_hubungan, emergency_phone, emergency_address, `index`) VALUES ('$id', '$emergency_name_2', '$emergency_hubungan_2', '$emergency_phone_2', '$emergency_address_2', 2);";

    if (mysqli_query($connect, $query)) {
        if(mysqli_query($connect, $query_2) && mysqli_query($connect, $query_3)){
