...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $insert_history_query = "INSERT INTO permission_history (id, permission_id, action, action_by, action_dt) VALUES (NULL, '$idPermission', 'Izin telah ditolak oleh HRD', '$employee_id', '$currentDateTimeString');";
