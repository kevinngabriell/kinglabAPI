...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    $query = "SELECT A1.id_permission, A3.permission_type_name, A2.employee_name ,A1.permission_date, A4.permission_status_name, A1.start_cuti
